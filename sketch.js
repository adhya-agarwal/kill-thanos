...
function setup() {
  ...
  stand1 = new Stand(170,600,1450,20);
 // stand2 = new Stand(900,500,200,10);
  ...
  thanos=new Villian(840,400,150,250)
...
function draw() {
 ...
 textSize(30)
 fill("hotpink")
 text("Drag black widow backwards like a slingshot to shoot the building and kick thanos off",120,50);
